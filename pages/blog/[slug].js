...
const Paragraph = (props) => {
  ...
  if (typeof props.children !== "string" && props.children.type === "img") {
    return (
      <figure>
        <div
          className={`relative min-h-[120px] sm:border border-neutral-200 dark:border-neutral-800 rounded-lg transition-colors ${isLoaded ? "" : "img-loading-spin"
            } `}
        >
          <Zoom
              ...
              <div className="flex flex-col gap-3 py-1">
                <div className="flex gap-2 items-center">
                  ...
                  <div className="flex flex-col grow gap-2">
                    <div className="font-medium leading-none">吴超亮</div>
