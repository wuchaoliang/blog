      ...
      <main className="resume max-w-2xl mx-auto pt-8 sm:pb-12 sm:pt-14 px-5 md:px-3">
        ...
        <section className='resume-info flex flex-col gap-6 sm:gap-8'>
          ...
          <section className='contact'>
            ...
            <p><span>网站：</span><span><Link href="/" target="_blank" title="吴超亮 LRD.IM">lrd.im</Link></span></p>
          </section>
        </section>
          ...
          <section>
            ...
            <div>
              ...
              <ul>
                ...
                <li>以<Link href="/blog/2021-04-09" target="_blank" title="分享会文稿 - 吴超亮的设计博客">分享会</Link>或文档的方式沉淀设计经验，与团队一起进步。</li>
              </ul>
            </div>
          </section>
          <section>
